...
**The Codes regarding this Multi-Linear Regression model with two different business problems *Start-ups profit prediction*, *Toyota price prediction* with their datasets are present in this Repository in detail**
